		...
		<div class="row">
			<div class="col-sm-12">
				<div class="wrapper-about-us bg-white">
					...
					<div class="content">
						<p>
							Cookindo is an online recipe directory from Indonesia that allowing user to search for any kind of recipes according to their needs. To find the recipes, cookindo providing a complete search filter, whether it is filtered by price range, number of people, or any kind of composition.
						</p>
						<p>
							Cookindo is founded by:
						</p>
