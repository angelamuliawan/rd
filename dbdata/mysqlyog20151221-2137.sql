...
insert  into `userlog`(`UserLogID`,`Browser`,`IPAddress`,`AccessDate`,`AuditedActivity`,`AuditedTime`,`AuditedUser`) values (1,'Firefox','10.1.20.300','2015-12-18 20:38:55','C','2015-12-18 20:38:55',1);
...
BEGIN
	INSERT INTO userlog
	(Browser, IPAddress, AccessDate, AuditedActivity, AuditedTime, AuditedUser)
	VALUES
	(ParamBrowser, ParamIPAddress, CURRENT_TIMESTAMP(), 'C', CURRENT_TIMESTAMP(), ParamUserID);
    END */$$
DELIMITER ;
